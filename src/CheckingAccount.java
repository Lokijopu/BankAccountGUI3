...
public class CheckingAccount extends BankAccount{
	...
	private int acctNum;
	public CheckingAccount(String n, double b, double odf, double tf, int freeTrans, int aN) {
		super(n, b);
		try {
		OVER_DRAFT_FEE = odf;
		TRANSACTION_FEE = tf;
	...
	public CheckingAccount(String n, double odf, double tf, int freeTrans, int aN) {
		super(n, 0);
		OVER_DRAFT_FEE = odf;
		TRANSACTION_FEE = tf;
		FREE_TRANS = freeTrans;
